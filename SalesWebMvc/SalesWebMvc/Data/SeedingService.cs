...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Bob Browb", "bob@gmail.com", new DateTime(1998,4,24), 1000.0, d4);
            Seller s2 = new Seller(2, "Maria Green", "maria@gmail.com", new DateTime(1992, 2, 21), 2000.0, d3);
            Seller s3 = new Seller(3, "Josef Grey", "josef@gmail.com", new DateTime(1990, 8, 10), 3000.0, d2);
            Seller s4 = new Seller(4, "Alice Pink", "alice@gmail.com", new DateTime(1989, 10, 22), 2500.0, d1);
            Seller s5 = new Seller(5, "Luis Blue", "luis@gmail.com", new DateTime(1995, 7, 9), 1000.0, d2);
            Seller s6 = new Seller(6, "Alex Red", "Alex@gmail.com", new DateTime(1998, 12, 25), 1000.0, d4);
